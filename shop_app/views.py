...
#         # context['categories'] = Category.objects.filter(parent=None)  # Category মডেলের সব অবজেক্ট পাঠানো হলো
...
# #     # এখানেই queryset ঠিক করে দিচ্ছি
# #
...
# #     def get_context_data(self, **kwargs):
# #         context = super().get_context_data(**kwargs)
# #         context['parent_categories'] = Category.objects.filter(parent=None)  # Category মডেলের সব অবজেক্ট পাঠানো হলো
# #         # context['categories'] = Category.objects.all()  # Category মডেলের সব অবজেক্ট পাঠানো হলো
# #         return context
#
#
...
# #     return render(request, 'shop_app/home.html', {'categories': categories})
#
#
#
#
...
#         context['children'] = category.children.all()  # ✅ child গুলো পাঠালাম
...
#     model = Product
#     template_name = 'shop_app/offers.html'
#     context_object_name = 'products'
#
#     def get_context_data(self, **kwargs):
#         context = super().get_context_data(**kwargs)
...
#
#         return context
# class OfferDetails(ListView):
#     model = Product
#     template_name = 'shop_app/offer_details.html'
#     context_object_name = 'products'
#
#     def get_context_data(self, **kwargs):
#         context = super().get_context_data(**kwargs)
