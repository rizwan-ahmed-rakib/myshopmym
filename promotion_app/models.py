...
class VideoPromotion(models.Model):
    ...
    google_drive_video_id = models.CharField(max_length=100, blank=True, null=True)

    created_at = models.DateTimeField(auto_now_add=True)

    def save(self, *args, **kwargs):
        url = (self.full_video_url or "").strip()  # ✅ Empty safety & trim spaces

        # Reset IDs to avoid stale data
        self.youtube_video_id = None
        self.facebook_video_id = None
        self.google_drive_video_id = None
